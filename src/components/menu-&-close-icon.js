...
const MenuAndCloseIcon = ({onClick, showSideNav, menuHeight, closeHeight, onMenuClick}) => {
   
    return(
        <div className="menuAndCloseIcon">
            {!showSideNav ? <li style={{height: menuHeight, overflow: 'hidden'}}  onClick={onMenuClick}><svg  xmlns="http://www.w3.org/2000/svg" width="38" height="37" viewBox="0 0 24 24"><path d="M24 6h-24v-4h24v4zm0 4h-24v4h24v-4zm0 8h-24v4h24v-4z"/></svg></li> :
